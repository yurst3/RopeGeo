...
export const TEXT_STYLE: TextStyleProfile = {
  ...
  map: {
    ...
    relevantInfoStrengthLabel: { fontSlot: "ui", fontWeight: "500" },
    relevantInfoHiddenPill: { fontSlot: "ui", fontWeight: "500" },
    measurementContextPill: { fontSlot: "ui", fontWeight: "400" },
